...
function CheckOutPage() {
    ...
    async function handleSubmit(e, userDetails){
       ...
       const newOrder = {
        ...
        productsIds : store.map(item => item?._id),
        totalPrices : totalCost
       }
  ...
  return (
    ...
    <div className="container max-w-screen-lg mx-auto">
        <div>
            ...
            <p className="text-gray-500 mb-2">Total Price: ${totalCost ? totalCost : 0}</p>
            <p className="text-gray-500 mb-6">Items:{store.length > 0 ? store.length : 0}</p>
            </div>

            <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    <form onSubmit={(e) => handleSubmit(e, userDetails)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
